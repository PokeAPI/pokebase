...
def berry(id_or_name, **kwargs):
    ...
    :arg id_or_name: id or name of the resource to lookup
    :returns: APIResource with the appropriate data
    """
...
def contest_effect(id_, **kwargs):
    ...
    :arg id_: id of the resource to lookup
    :returns: APIResource with the appropriate data
    """
